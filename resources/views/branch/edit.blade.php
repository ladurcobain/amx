            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        @if (!empty($info))
                            <form method="post" action="{{ route('branch.update') }}"class="needs-validation" novalidate
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" name="name" placeholder="Nama Cabang" value="{{ $info->name }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <textarea name="address" placeholder="Alamat" class="form-control" 
                                            autocomplete="off" required="required" rows="6">{{ $info->address }}</textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-lg-3">No.Telpon <span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                        <input type="number" name="phoneNumber" placeholder="No.Telpon" value="{{ $info->phoneNumber }}"
                                            class="form-control" autocomplete="off" required="required" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="form-select" aria-label="Default select example" name="cityId">
                                            <option value="{{ $info->City->id }}">{{ $info->City->name }}</option>
                                            @foreach ($resKota as $kota)
