            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        @if (!empty($info))
                            <form method="post" action="{{ route('customer.update') }}"class="needs-validation" novalidate
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="number" maxlength="15" name="phoneNumber" placeholder="Nama Lengkap"
                                            value="{{ $info->phoneNumber }}" class="form-control" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" name="address" placeholder="Alamat" value="{{ $info->address }}"
                                            class="form-control" />
                                    </div>
                                </div>
                                <div class="row mb-3">
