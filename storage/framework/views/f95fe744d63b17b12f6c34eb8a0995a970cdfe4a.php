            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <?php if(!empty($info)): ?>
                            <form method="post" action="<?php echo e(route('forwarder.update')); ?>"class="needs-validation" novalidate
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" name="name" placeholder="Forwarder" value="<?php echo e($info->name); ?>"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="form-select" aria-label="Default select example" name="originProvince">
                                            <option value="<?php echo e($info->Origin->id); ?>"><?php echo e($info->Origin->name); ?></option>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="form-select" aria-label="Default select example" name="destinationProvince">
                                            <option value="<?php echo e($info->Destination->id); ?>"><?php echo e($info->Destination->name); ?></option>
                                            <?php $__currentLoopData = $resProvinsi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $provinsi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($provinsi->id); ?>"><?php echo e($provinsi->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\amx\resources\views/forwarder/edit.blade.php ENDPATH**/ ?>