        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <div>
                        <button type="button" OnClick="link_add('provinsi');"
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div>
                            <form method="post" action="<?php echo e(route('provinsi.filter')); ?>">
                                    ...
                                    <?php if(!empty($results)): ?>
                                        <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td align="center">
													<span class="badge text-<?php echo ($row->status != true) ? "bg-secondary":"bg-primary"; ?>"><?php echo e(App\Helpers\Status::tipeStatus($row->status)); ?> </span>
												</td>
                                                <td align="center">
                                                    <div class="hstack gap-1 mt-4 mt-sm-0">
                                                        <button type="button"
                                                            onClick="edit_data('provinsi', '<?php echo e($row->id); ?>');"
                                                            class="btn btn-outline-warning btn-sm waves-effect waves-light">Ubah</button></button>
                                                        <button type="button"
                                                            onClick="delete_data('provinsi', '<?php echo e($row->id); ?>');"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/hmamacbook/Documents/Project yoga/amx/resources/views/provinsi/index.blade.php ENDPATH**/ ?>