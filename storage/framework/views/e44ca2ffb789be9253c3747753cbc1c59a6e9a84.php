            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div>
                            <form method="post" action="<?php echo e(route('forwarder.filter')); ?>">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-group">
                                            <input type="text" class="form-control"
                                                placeholder="Cari Berdasarkan <?php echo e(ucfirst($title)); ?> ..."
                                    ...
                                    <?php if(!empty($results)): ?>
                                        <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($row->Origin->name); ?></td>
                                                ...
                                                <td align="center">
                                                    <div class="hstack gap-1 mt-4 mt-sm-0">
                                                        <button type="button"
                                                            onClick="edit_data('forwarder', '<?php echo e($row->id); ?>');"
                                                            class="btn btn-outline-warning btn-sm waves-effect waves-light">Ubah</button></button>
                                                        <button type="button"
                                                            onClick="delete_data('forwarder', '<?php echo e($row->id); ?>');"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/hmamacbook/Documents/Project yoga/amx/resources/views/forwarder/index.blade.php ENDPATH**/ ?>