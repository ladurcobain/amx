                                    ...
                                    <?php if(!empty($results)): ?>
                                        <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td align="center">
													<span class="badge text-<?php echo ($row->status != true) ? "bg-secondary":"bg-primary"; ?>"><?php echo e(Status::tipeStatus($row->status)); ?> </span>
												</td>
                                                <td align="center">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/amx/resources/views/provinsi/index.blade.php ENDPATH**/ ?>