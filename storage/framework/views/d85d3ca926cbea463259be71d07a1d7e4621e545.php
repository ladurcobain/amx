            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div>
                            <form method="post" action="<?php echo e(route('branch.store')); ?>"class="needs-validation" novalidate
                                enctype="multipart/form-data">
                                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
                                <div class="row mb-3">
                                    <label class="col-lg-3">Nama Cabang <span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                        <input type="text" name="name" placeholder="Nama Cabang" value=""
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <textarea name="address" placeholder="Alamat" value="" class="form-control" 
                                            autocomplete="off" required="required" rows="6"></textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-lg-3">No.Telpon <span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                        <input type="number" name="phoneNumber" placeholder="No.Telpon" value=""
                                            class="form-control" autocomplete="off" required="required" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="form-select" aria-label="Default select example" name="cityId">
                                            <option selected disabled>== Sesuaikan Dengan Provinsi ==</option>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\amx\resources\views/branch/create.blade.php ENDPATH**/ ?>