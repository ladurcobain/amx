    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <div>
                    <button type="button" OnClick="link_add('user');" class="btn btn-sm btn-secondary btn-label waves-effect waves-light"><i class="ri-add-circle-line label-icon align-middle fs-16 me-2"></i> Tambah</button>
                </div>
            </div>
            <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Cari Berdasarkan Nama <?php echo e(ucfirst($title)); ?> ..." value="<?php echo e($q); ?>" name="keyword" autocomplete="off" />
