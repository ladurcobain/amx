            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div>
                            <form method="post" action="<?php echo e(route('kota.store')); ?>"class="needs-validation" novalidate
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/hmamacbook/Documents/Project yoga/amx/amx/resources/views/kota/create.blade.php ENDPATH**/ ?>