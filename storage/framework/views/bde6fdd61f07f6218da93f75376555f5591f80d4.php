...
unset($__errorArgs, $__bag); ?>" id="username" name="username" placeholder="Enter username" autocomplete="off" value="Jakarta" />
...
unset($__errorArgs, $__bag); ?>" name="password" placeholder="Enter password" id="password-input" autocomplete="off" value="Indonesia" />
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/hmamacbook/Documents/Project yoga/amx/amx/resources/views/auth/login.blade.php ENDPATH**/ ?>